...
- Выявлять ключевые риски информационной безопасности на основе защищаемой инфраструктуры и бизнес-процессов;
...
- Анализировать защищенности активов;
- Разрабатывать организационно-распорядительную документацию;
- Контролировать выполнение требований безопасности (организация и проведение аудитов, анализов защищенности, тестирований на проникновение);
